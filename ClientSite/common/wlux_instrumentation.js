...
var WLUX = (function () {
    ...
    function setupTaskbar() {
        ...
        var link = $wlux('<a>').attr({
            'href': study_data.returnUrl + "?wlux_session=" + SESSION_ID + "&wlux_task=" + study_data.taskId,
            'class': 'wlux_button_link'
        });

        var buttonDiv = $wlux('<div>').attr({
            'id': 'wlux_return',
            'class': 'wlux_button_div'
        });

        var taskbar = $wlux('<div>').attr({
            'id': 'wlux_taskbar',
            'class': 'wlux_taskbar'
        });

        var toggle = $wlux('<div>').attr({
            'id': 'wlux_toggle',
            'class': 'wlux_tab'
        })
