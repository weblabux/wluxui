...
CREATE TABLE IF NOT EXISTS session_config (
  ...
  variationCssUrl varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  taskBarCssUrl varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,  
