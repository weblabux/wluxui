...
INSERT INTO study_periods (studyPeriodId, studyId, periodName, periodDescription, periodParticipantLimit, periodStartTime, periodEndTime, periodAnnouncementText, periodEmailList, periodTaskSequence, periodStudyVariations, periodTimeZone, dateCreated, dateModified) VALUES 
(1, 1234, 'The first period', 'The first period of the test study', NULL, '2014-02-10 00:00:00', '2014-02-15 00:00:00', NULL, NULL, 'random', 'singleRandom', 'UTC−08 America/Los_Angeles', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1234, 'The second period', 'The first period of the test study', 500, '2014-02-17 00:00:00', '2014-02-22 00:00:00', NULL, NULL, 'random', 'singleRandom', 'UTC−08 America/Los_Angeles', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('3', '1234', 'Third Period', 'Third Period Test Data', '250', '2014-04-01 03:00:00.000000', '2014-04-04 06:17:30.000000', 'This is the third period announcement', 'NULL', 'random', 'singleRandom', 'UTC−08 America/Los_Angeles', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);